...
Modify the auth server's [`config.json`](sample-configs/step-2/auth-server/server/config.json)
to use ports [3002 (HTTP)](sample-configs/step-2/auth-server/server/config.json#L4)
