...
way to authenticate the client. Let's modify the auth server to allow resource
requests for users who authenticate via the [OAuth 2.0 Authorization Code Grant](http://docs.strongloop.com/display/LGW/Developer%27s+Guide#Developer'sGuide-Authorizationcodegrant)
flow.
